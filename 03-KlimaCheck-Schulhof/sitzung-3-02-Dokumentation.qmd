...
**KlimaCheck-Schulhof** ist ein vereinfachtes, didaktisches Mikroklima-Modell für Schulhof-Workshops. Das Modell bildet keinen realen Schulhof prognostisch exakt ab. Es dient als **physikalisch plausibles Vergleichsmodell**, mit dem Schülerinnen und Schüler untersuchen können, wie Materialien, Gebäude, Schatten, Vegetation, Dachbegrünung und Fassadenbegrünung die thermische Belastung auf Aufenthaltsflächen verändern.

Die Modellphysik ist semi-mechanistisch. Sie berechnet Oberflächentemperaturen aus einer vereinfachten Energiebilanz und koppelt diese an ein parametrisiertes bodennahes Luftfeld. Material-, Schatten-, Wasser- und Vegetationseffekte wirken über getrennte Prozesspfade. Der Variantenvergleich ist deshalb physikalisch begründet, solange er relativ und modellintern interpretiert wird. Die absolute Temperaturhöhe und die exakte Stärke einzelner Maßnahmen sind dagegen nicht validiert und daher nicht als Prognose zu verwenden.

Das Modell verwendet effektive Prozessparameter. Diese Parameter sind nicht als willkürliche didaktische Stellgrößen zu verstehen, sondern als notwendige Näherungen für physikalische Prozesse, die im vereinfachten zweidimensionalen Modell nicht vollständig aufgelöst werden. Insbesondere löst das Modell keine vollständige Massen- und Impulserhaltung des bodennahen Luftvolumens. Deshalb werden Wärmeübergang, vertikale und laterale Luftmischung, Verdunstung, Substratkopplung und Fassadenwirkung über effektive Koeffizienten beschrieben. Die Parameter sind so gewählt, dass die bekannten physikalischen Wirkungsrichtungen und die relativen Unterschiede zwischen Materialien und Maßnahmen plausibel abgebildet werden.


>Die Physik ist hart genug für relative Wirkungsvergleiche, aber nicht hart genug für quantitative Planungsaussagen.

Der zentrale Einsatzfall ist vor diesem Hintergrund nicht die Vorhersage absoluter Temperaturen, sondern der Vergleich von Varianten:
